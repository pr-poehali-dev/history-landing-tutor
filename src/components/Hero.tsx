...
const Hero = () => {
  return (
    <section className="bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-500 py-20 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-xl text-emerald-50 mb-8 max-w-3xl mx-auto font-open-sans">
        ...
        <Button
          size="lg"
          className="bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-500 hover:to-yellow-600 text-gray-900 px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
        >
          Записаться на курс
        </Button>
      </div>
